...
1.  **Identify Active Feature:** Determine the current feature directory from the session context (e.g., `.features/sc-12345`) and construct the full path to its `review.yml` file.
