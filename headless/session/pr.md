...
*   **Feature Directory:** Call `run_shell_command` with the command `$AI_SESSION_HOME/scripts/resolve_feature_dir.sh "{{args}}"` to get the path to the feature directory.
